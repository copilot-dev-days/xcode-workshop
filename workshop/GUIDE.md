...
| [**01**](01-setup.md) | Prerequisites & Setup |
| [**02**](02-chat.md) | Understanding Code with Copilot Chat |
| [**03**](03-completion.md) | Code Completion with Inline Suggestions |
| [**04**](04-agent-mode.md) | Agent Mode — Multi-File Refactoring |
| [**05**](05-plan-agent.md) | Plan Agent — Breaking Down Complex Tasks |
| [**06**](06-mcp.md) | GitHub MCP Server Integration |
| [**07**](07-vision.md) | Copilot Vision (Optional) |
| [**08**](08-tips-and-resources.md) | Best Practices, Tips & Resources |
